<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"><a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">ForLove.admin</a>
            <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a> <span
                class="logo navbar-slogan f-l mr-10 hidden-xs">v2.4</span> <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
            ...
            <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
                <ul class="cl">
                    <li>
                        <?php if ($this->session->userdata('power') == 1) { ?>
                            超级管理员
                        <?php } else { ?>
                            普通管理员
                        <?php } ?>
                    ...
                    <li class="dropDown dropDown_hover"><a href="#"
                                                           class="dropDown_A"><?php echo $this->session->userdata('username'); ?>
                            <i
                                class="Hui-iconfont">
                                &#xe6d5;</i></a>
                        <ul class="dropDown-menu menu radius box-shadow">
                            <li><a href="<?php echo base_url('Admin/Login/signOut'); ?>">退出</a></li>
                        </ul>
                    </li>
